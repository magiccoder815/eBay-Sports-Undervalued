...
base_url = "https://www.ebay.com/sch/i.html?_dcat=212&_udlo=100&_fsrp=1&_from=R40&_ipg=240&Sport={}&_nkw=PSA&_sacat=64482&Grade=8%7C8%252E5%7C9%7C9%252E5%7C10%7C%21&Season=2020%7C2020%252D21%7C2021%7C2021%252D22%7C2022%7C2022%252D23%7C2023%7C2023%252D24%7C2024%7C2025&_sop=10&rt=nc&LH_BIN=1&_pgn={}"
...
for sport_name in sports:
    ...
    output_dir = os.path.join("BuyItNow", sport_name)
    ...
    try:
        while True:
            ...
            print(f"BIN items found on page {page}: {items_count}")
            ...
            page_filename = os.path.join(output_dir, f"{sport_name}_BIN_Data_Page_{page}.xlsx")
    ...
    final_filename = os.path.join(output_dir, f"{sport_name}_BIN_Data.xlsx")
    df_final.to_excel(final_filename, index=False)
    print(f"BIN data for {sport_name} saved to '{final_filename}'.")
